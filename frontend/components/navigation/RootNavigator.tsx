 ...
 * File này giữ lại để tham khảo cách thiết kế Root Navigator với Auth flow
 * 
 * Code thực tế đang chạy:
 * - Root layout: frontend/app/_layout.tsx (với AuthProvider)
 * - Index redirect: frontend/app/index.tsx (check auth và redirect)
 * - Auth flow: frontend/app/(auth)/_layout.tsx
 * - Main tabs: frontend/app/(tabs)/_layout.tsx
 */
